...
class FeedLikeServiceTest {
    ...
    class 좋아요기능확인{
        ...
        void 좋아요갯수확인테스트(){
            ...
            FeedLikeCountRequest feedLikeCountRequest = FeedLikeCountRequest.builder()
                    .feedId(Long.valueOf(1))
                    .build();

            BDDMockito.given(
                    feedLikeRepository.countFeedLikeByFeedId(any())
            ).willReturn(20);
        ...
        void 좋아요추가(){
            ...
            FeedLikeRequest feedLikeRequest = FeedLikeRequest.builder()
                    .feedId(Long.valueOf(1))
                    .userId(Long.valueOf(1))
                    .build();

            BDDMockito.given(
                    feedLikeRepository.findOneByFeedIdAndUserId(any(), any())
