...
class RegionControllerTest {
    ...
    void 매퍼등록및단건등록() throws Exception{
        ...
        regionRegistRequest = RegionRegistRequest.builder()
                .si("서울시")
                .gungu("중구")
                .build();
        ...
        BDDMockito.given(
                regionService.findOneByRegionId(Long.valueOf(1))
        ).willReturn(regionResponse);

        BDDMockito.given(regionService.findAll())
                .willReturn(regionResponses);
    ...
    class 등록테스트 {
        ...
        void 정상지역등록() throws Exception{
            ...
            RegionResponse result = mapper.readValue(
